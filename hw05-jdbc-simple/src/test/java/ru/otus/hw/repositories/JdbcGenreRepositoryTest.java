...
class JdbcGenreRepositoryTest {
    ...
    void shouldReturnEmptyOptionalForNonExistentId() {
        Optional<Genre> actualGenre = repositoryJdbc.findById(999L);
    ...
    @DisplayName("должен возвращать жанры в правильном порядке (по id)")
    @Test
    void shouldReturnGenresInCorrectOrder() {
        List<Genre> actualGenres = repositoryJdbc.findAll();
